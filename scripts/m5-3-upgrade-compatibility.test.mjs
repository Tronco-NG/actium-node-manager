...
mkdir -p "$stage_root/usr/lib/actium/node-manager" "$stage_root/etc/actium/node-manager" "$stage_root/var/lib/actium/node-manager/identity" "$stage_root/etc/systemd/system" "$stage_root/actium/nodes/historical-node/state"
