    ...
    `<main class="manager-shell runtime-units-shell">
      <section class="runtime-fabric-card">
        <div>
          ...
          <small>${inventory ? `fabric_id ${escapeHtml(inventory.fabric.fabricId)} · red ${escapeHtml(inventory.fabric.networkName)}` : "Consultando Actium Node Supervisor 0.5.5"}</small>
        </div>
